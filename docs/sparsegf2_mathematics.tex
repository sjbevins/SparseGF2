...
(graph-defined monitored Clifford circuits). Part~III records implementation
status and the remaining roadmap, including the Bravyi--Maslov sampler,
batched execution, and finite-size-scaling analysis.
\end{abstract}
